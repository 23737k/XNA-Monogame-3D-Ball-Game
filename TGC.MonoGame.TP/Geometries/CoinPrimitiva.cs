...
namespace TGC.MonoGame.TP.Geometries
{
    ...
    /// </summary>
    public class CoinPrimitive : GeometricPrimitive
    {
        /// <summary>
        ///     Constructs a new cylinder primitive, with the specified size and tessellation level.
        /// </summary>
        public CoinPrimitive (GraphicsDevice graphicsDevice,
                                  float height = 1,
                                  float diameter = 1,
                                  int tessellation = 32) 
        {
            ...
            for (var i = 0; i < tessellation; i++)
            {
                ...
                AddVertex(normal * radius + Vector3.Up * height, Color.Yellow, normal);
                AddVertex(normal * radius + Vector3.Down * height, Color.Yellow, normal);
        ...
        private void CreateCap(int tessellation, float height, float radius, Vector3 normal)
        {
            ...
            for (var i = 0; i < tessellation; i++)
            {
                ...
                AddVertex(position, Color.Yellow, normal);
            }
        }
