    ...
    public class CylinderPrimitive : GeometricPrimitive
    {
                                  ...
                                  int tessellation = 32) 
        {
            ...
            for (var i = 0; i < tessellation; i++)
            {
                ...
                AddVertex(normal * radius + Vector3.Up * height, Color.MonoGameOrange, normal);
                AddVertex(normal * radius + Vector3.Down * height, Color.MonoGameOrange, normal);
        ...
        private void CreateCap(int tessellation, float height, float radius, Vector3 normal)
        {
            ...
            for (var i = 0; i < tessellation; i++)
            {
                ...
                AddVertex(position, Color.MonoGameOrange, normal);
            }
        }
