...
namespace TGC.MonoGame.TP.Geometries
{
    ...
    /// </summary>
    public class TrunkPrimitive : GeometricPrimitive
    {
        /// <summary>
        ///     Constructs a new cylinder primitive, with the specified size and tessellation level.
        /// </summary>
        public TrunkPrimitive (GraphicsDevice graphicsDevice,
                                  float height = 1,
                                  float diameter = 1,
                                  int tessellation = 32) 
        {
            ...
            for (var i = 0; i < tessellation; i++)
            {
                ...
                AddVertex(normal * radius + Vector3.Up * height, Color.SandyBrown, normal);
                AddVertex(normal * radius + Vector3.Down * height, Color.SandyBrown, normal);
        ...
        private void CreateCap(int tessellation, float height, float radius, Vector3 normal)
        {
            ...
            for (var i = 0; i < tessellation; i++)
            {
                ...
                AddVertex(position, Color.SandyBrown, normal);
            }
        }
